...
# from app_temp import send_email
from models import (
...
# Brevo SMTP (RECOMMENDED)
app.config['MAIL_SERVER'] = 'smtp-relay.brevo.com'
app.config['MAIL_PORT'] = 587
app.config['MAIL_USE_TLS'] = True

app.config['MAIL_USERNAME'] = os.getenv("MAIL_USERNAME")   # Brevo Login
...
def test_mail():
    try:
        send_email("your-email@example.com", "Test", "Email works!")
        return "Sent!"
